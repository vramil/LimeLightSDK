...
class Transaction extends LimeLight
{
     ...
     * |                                                    |
     * \***************************************************/
    function __construct($api_username, $api_password, $lime_light_url, $output_type = 'array')
    {
        // set the parent variables
        parent::__construct($api_username, $api_password, $lime_light_url, $output_type);
    ...
    private function NewOrder(
        ...
        if (strtolower($credit_card_type) == 'paypal') {
            ...
            if ($credit_card_type == 'checking' || $credit_card_type == 'eft_germany') {
    ...
    private function NewOrderCardOnFile(
        $product_id,
        $campaign_id,
        $shipping_id,
        $previous_order_id,
    ...
    private function NewOrderWithProspect(
        $credit_card_type,
        $credit_card_number,
        $credit_card_exp_mmyy,
        $credit_card_cvv,
    ...
    public function GetResponse($do_what, $parameters)
    {
        ...
        switch (strtolower($do_what)) {
            case 'neworder':
            default:
                $this->NewOrder($parameters[0], $parameters[1], $parameters[2], $parameters[3], $parameters[4], $parameters[5], $parameters[6], $parameters[7], $parameters[8], $parameters[9], $parameters[10], $parameters[11], $parameters[12],
                    $parameters[13], $parameters[14], $parameters[15], $parameters[16], $parameters[17], $parameters[18], $parameters[19], $parameters[20], $parameters[21], $parameters[22], $parameters[23], $parameters[24], $parameters[25],
                    $parameters[26], $parameters[27], $parameters[28], $parameters[29], $parameters[30], $parameters[31], $parameters[32], $parameters[33], $parameters[34], $parameters[35], $parameters[36], $parameters[37], $parameters[38],
                    $parameters[39], $parameters[40], $parameters[41], $parameters[42], $parameters[43], $parameters[44], $parameters[45], $parameters[46], $parameters[47]);
                break;
            ...
            case 'neworderwithprospect':
                $this->NewOrderWithProspect($parameters[0], $parameters[1], $parameters[2], $parameters[3], $parameters[4], $parameters[5], $parameters[6], $parameters[7], $parameters[8], $parameters[9], $parameters[10], $parameters[11],
                    $parameters[12], $parameters[13], $parameters[14], $parameters[15], $parameters[16], $parameters[17], $parameters[18], $parameters[19], $parameters[20], $parameters[21], $parameters[22], $parameters[23], $parameters[24],
                    $parameters[25], $parameters[26], $parameters[27], $parameters[28], $parameters[29], $parameters[30]);
                break;
            case 'newprospect':
                $this->NewPropspect($parameters[0], $parameters[1], $parameters[2], $parameters[3], $parameters[4], $parameters[5], $parameters[6], $parameters[7], $parameters[8], $parameters[9], $parameters[10], $parameters[11], $parameters[12],
                    $parameters[13], $parameters[14], $parameters[15], $parameters[16], $parameters[17], $parameters[18], $parameters[19], $parameters[20], $parameters[21]);
                break;
        }    // END switch
